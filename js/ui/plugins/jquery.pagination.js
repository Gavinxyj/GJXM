...
(function($) {
	function _1(_2) {
		...
		$("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(
				tr);
		$("<span style=\"padding-left:6px;\"></span>").html(_4.beforePageText)
	...
	function _10(_11, _12) {
		...
		_15 = _15.replace(/{from}/, _13.total == 0 ? 0 : _13.pageSize
				* (_13.pageNumber - 1) + 1);
		_15 = _15.replace(/{to}/, Math.min(_13.pageSize * (_13.pageNumber),
				_13.total));
	...
	$.fn.pagination = function(_1a, _1b) {
		...
		return this.each(function() {
			...
			if (_1d) {
				...
				_1c = $.extend({}, $.fn.pagination.defaults, $.fn.pagination
						.parseOptions(this), _1a);
		...
		nav : {
			...
			refresh : {
				...
				handler : function() {
					...
					if (_2e.onBeforeRefresh.call(this, _2e.pageNumber,
							_2e.pageSize) != false) {
