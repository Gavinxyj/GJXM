...
function loadInfo()
{
    ...
    {  
        ...
        {  
        	...
        	document.getElementById("street").innerHTML = context;
...
function fileUpLoad()
{
    ...
    {  
		...
		//	alert(json.row.length);
			...
			var tb = document.getElementById("boxBean");
			...
			for(var index = 0; index < json.row.length; index ++)
			{
				...
				var context = "<button type = 'button'>修改</button>";
				
				var colOperator = row.insertCell();
				colOperator.innerHTML = context;
			}
        }
    } 
}
